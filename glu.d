...
GLint gluBuild2DMipmapLevels(GLenum target, GLint internalFormat,
		...
		GLint base, GLint max, void* data);
...
GLint gluBuild3DMipmapLevels(GLenum target, GLint internalFormat,
		...
		GLenum type, GLint level, GLint base, GLint max, void* data);
...
void gluLoadSamplingMatrices(GLUnurbs* nurb, GLfloat* model,
...
void gluNurbsSurface(GLUnurbs* nurb, GLint sKnotCount, GLfloat* sKnots,
...
GLint gluProject(GLdouble objX, GLdouble objY, GLdouble objZ, GLdouble* model,
		GLdouble* proj, GLint* view, GLdouble* winX, GLdouble* winY,
		GLdouble* winZ);

void gluPwlCurve(GLUnurbs* nurb, GLint count, GLfloat* data, GLint stride,
		GLenum type);
...
GLint gluScaleImage(GLenum format, GLsizei wIn, GLsizei hIn, GLenum typeIn,
		void* dataIn, GLsizei wOut, GLsizei hOut, GLenum typeOut,
		GLvoid* dataOut);
...
GLint gluUnProject(GLdouble winX, GLdouble winY, GLdouble winZ,
		GLdouble* model, GLdouble* proj, GLint* view, GLdouble* objX,
		GLdouble* objY, GLdouble* objZ);

GLint gluUnProject4(GLdouble winX, GLdouble winY, GLdouble winZ,
		GLdouble clipW, GLdouble* model, GLdouble* proj, GLint* view,
		GLdouble nearVal, GLdouble farVal, GLdouble* objX, GLdouble* objY,
