...
class KeysState
{
  ...
  void update(int key, int action)
  {
    ...
    if(action == GLFW_PRESS)
    {
      switch(key)
      {
        case GLFW_KEY_LCTRL: this.lCtrl = true; break;
        case GLFW_KEY_LSHIFT: this.lShift = true; break;
        case GLFW_KEY_LALT: this.lAlt = true; break;
        ...
        case GLFW_KEY_DEL: this.del = true; break;
        default: break;
      }
    }
    else
    if(action == GLFW_RELEASE)
    {
      switch(key)
      {
        case GLFW_KEY_LCTRL: this.lCtrl = false; break;
        case GLFW_KEY_LSHIFT: this.lShift = false; break;
        case GLFW_KEY_LALT: this.lAlt = false; break;
        ...
        case GLFW_KEY_DEL: this.del = false; break;
        default: break;
      }
    }
  }
